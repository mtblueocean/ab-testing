    ...
    class WWPP_Wholesale_Role_Payment_Gateway {
        ...
        */
        ...
        public function filter_available_payment_gateways( $available_gateways ) {
            ...
            if ( current_user_can( 'manage_options' ) || empty( $user_wholesale_role ) || empty( $wholesaleRolePaymentGatewayMapping ) )
            ...
            foreach ( $wholesaleRolePaymentGatewayMapping as $wholesaleRoleKey => $paymentGateways ) {
                ...
                if ( $wholesaleRoleKey != $user_wholesale_role[ 0 ] ) continue;
        ...
        */
        ...
        public function add_payment_gateway_surcharge( $surcharge_data = null ) {
            ...
            $surcharge_mapping = get_option( WWPP_OPTION_PAYMENT_GATEWAY_SURCHARGE_MAPPING );
