...
if ( !class_exists( 'WWPP_WC_Product_Addon' ) ) {
    ...
    class WWPP_WC_Product_Addon {
        ...
        */
         ...
         * @return float Filtered wholesale price.
         */
        public function apply_addon_to_cart_items( $wholesale_price , $product_id , $user_wholesale_role , $cart_item ) {

            // Adjust price if addons are set
            if ( !empty( $wholesale_price ) && ! empty( $cart_item[ 'addons' ] ) && apply_filters( 'woocommerce_product_addons_adjust_price' , true , $cart_item ) ) {
                ...
                return $wholesale_price += $extra_cost;
