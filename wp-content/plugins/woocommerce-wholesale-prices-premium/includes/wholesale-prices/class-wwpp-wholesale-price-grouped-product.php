        ...
        public function wholesale_grouped_price_html( $price , $product ) {
            ...
            if ( !empty( $user_wholesale_role ) ) {
                ...
                foreach ( $product->get_children() as $child_id ) {
                    ...
                    $child_wholesale_price = WWP_Wholesale_Prices::get_product_wholesale_price_on_shop( $child_id , $user_wholesale_role );
                ...
                if ( $has_member_with_wholesale_price ) {
                    ...
                    if ( $min_price ) {
                        ...
                        $wholesale_price_range .= $display_price . apply_filters( 'wwp_filter_wholesale_price_display_suffix' , $product->get_price_suffix() );
                    ...
                    if ( strcasecmp( $wholesale_price_range , '' ) != 0 ) {
                        ...
                        return apply_filters( 'wwp_filter_wholesale_price_html' , $wholesale_price_html , $price , $product , $user_wholesale_role , $wholesale_price_title_text , $wholesale_price_range );
