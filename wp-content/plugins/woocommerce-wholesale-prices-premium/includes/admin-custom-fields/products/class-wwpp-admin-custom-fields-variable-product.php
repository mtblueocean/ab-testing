        ...
        public function add_minimum_order_quantity_custom_fields( $loop , $variation_data , $variation ) {
            ...
            <div class="wholesale-minium-order-quantity-options-group options-group options_group" style="border-top: 1px solid #DDDDDD;">
                ...
                <header class="form-row form-row-full">
                    ...
                    <p style="margin:0; padding:0; line-height: 16px; font-style: italic; font-size: 13px;"><?php _e( "Minimum number of items to be purchased in order to avail this product's wholesale price.<br/>Only applies to wholesale users." , 'woocommerce-wholesale-prices-premium' ); ?></p>
                </header>
