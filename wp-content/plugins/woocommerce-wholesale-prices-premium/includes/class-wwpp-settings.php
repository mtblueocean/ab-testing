    ...
    class WWPP_Settings {
        ...
        private function _get_tax_section_settings() {
            ...
            return array(
                ...
                array(
                    ...
                    'type'      => 'text',
                    'desc'      => __( 'Overrides the price suffix defined in the Tax settings section of WooCommerce for all prices.' , 'woocommerce-wholesale-prices-premium' ),
                    'desc_tip'  => __( 'Make this blank to use the default price suffix' , 'woocommerce-wholesale-prices-premium' ),
        ...
        */
        ...
        public function render_plugin_settings_custom_field_payment_gateway_surcharge_controls() {
            ...
            $surcharge_types = array( 'fixed_price' => 'Fixed Price' , 'percentage'  => 'Percentage' );

            require_once ( WWPP_VIEWS_PATH . 'plugin-settings-custom-fields/view-wwpp-payment-gateway-surcharge-controls-custom-field.php' );
         ...
         * @param $data
         */
        public function render_plugin_settings_custom_field_wwwpp_editor( $data ) {
        ...
        public function run() {
            ...
            add_action( 'woocommerce_admin_field_wwpp_editor'                                 , array( $this , 'render_plugin_settings_custom_field_wwwpp_editor' )                                , 10 , 1 );
