        ...
        */
        ...
        public function apply_tax_exemptions_to_wholesale_users_with_integration() {
            ...
            if ( !empty( $user_wholesale_role ) ) {
                ...
                // Check wwpp tax exemption option
        ...
        public function wholesale_tax_display_cart( $option_value ) {
            ...
            if ( ! empty( $user_wholesale_role ) || ( defined( 'DOING_AJAX' ) && DOING_AJAX && ! empty( $user_wholesale_role ) ) ) {
                ...
                if ( get_option( 'woocommerce_calc_taxes' , false ) === 'yes' ) {
                    ...
                    if ( array_key_exists( $user_wholesale_role , $wholesale_role_tax_option_mapping ) )
                        $tax_exempted = $wholesale_role_tax_option_mapping[ $user_wholesale_role ][ 'tax_exempted' ];
        ...
        public function run() {
            ...
            // Intentionally left the commented out below for reference, please do not remove ( WWPP-431 )
            // add_action( 'woocommerce_checkout_process'             , array( $this , 'apply_tax_exemptions_to_wholesale_users' ) , 9 );
		    // add_action( 'woocommerce_checkout_update_order_review' , array( $this , 'apply_tax_exemptions_to_wholesale_users' ) , 9 );
            ...
            add_filter( 'wwp_filter_wholesale_price_shop' , array( $this , 'integrate_tax_to_wholesale_price_on_shop' ) , 30 , 3 );
